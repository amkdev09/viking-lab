          ...
          <section className="site-footer__newsletter flex h-[444px]">
            ...
            <div className="site-footer__newsletter-content w-1/2">
              ...
              <p>
                ...
                specific services offered by your IT solution and the unique
              </p>
              <form
        ...
        <div className="container">
          <div className="site-footer__grid">
            ...
            <div>
              ...
              <ul>
                <li>
                  <a href="#">Direct Hire Solutions</a>
                </li>
                <li>
                  <a href="#">Recruitment Expertise</a>
                </li>
                <li>
          ...
          <div className="site-footer__bottom">
            <p>2024 recrute, All Rights Reserved. Design By VikingLab</p>
          </div>
        </div>
      </div>
    </footer>
